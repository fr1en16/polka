...
function WhatsAppIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className="mr-2 shrink-0">
    ...
    <div className="w-full min-h-[100dvh] bg-black flex flex-col items-center justify-center gap-10 px-6 py-12">
      ...
      <div className="flex gap-4 w-full max-w-[360px] px-2 animate-slide-up delay-150 justify-center">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex-1 flex items-center justify-center bg-[#25D366] text-white font-bold py-3.5 rounded-2xl hover-grow"
          style={{ ...INTER, fontSize: "15px" }}
        >
          <WhatsAppIcon />
          WhatsApp
        </a>
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex-1 flex items-center justify-center bg-[#0088cc] text-white font-bold py-3.5 rounded-2xl hover-grow"
          style={{ ...INTER, fontSize: "15px" }}
        >
          <TelegramIcon />
          Telegram
